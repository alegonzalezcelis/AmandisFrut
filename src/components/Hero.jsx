    ...
    <>
      ...
      >
        <div className="col-start-2 col-end-12 md:col-end-7 rounded-md my-auto">
          <h1 className="text-center md:text-left text-2xl mb-5">
            La mejor calidad de Cítricos con
            <br />
            <span className="text-center font-extrabold text-5xl md:text-6xl text-green-500">
              AmandisFrut
            </span>
          </h1>
          ...
          >
            <i className="fa-brands fa-whatsapp text-3xl"></i>¡Conversemos!
          </button>
        </div>
